...
public class NewsCatalystEvaluatorTests
{
    ...
    {
        var news = new NewsResult(true, null, new[] { Item(0.8, 0.4) });
    ...
    {
        var news = new NewsResult(true, null, new[] { Item(0.8, 0.05) });
    ...
    {
        var news = new NewsResult(true, null, new[] { Item(0.9, 0.5), Item(0.9, -0.5) }); // averages to ~0 -> Mixed
    ...
    public void LowRelevanceItemsAreExcludedFromTheAverage()
    {
        ...
        var news = new NewsResult(true, null, new[] { Item(0.9, -0.5), Item(0.05, 0.9) });
